...
В приложении есть PNG-превью готовой картинки, управление шириной первого столбца и колонок препаратов, а также скачивание единой PNG-картинки с metadata `600 dpi`. Значения `≈` отображаются как `-`.

Для PNG-экспорта в проекте лежат локальные шрифты:

- `fonts/DejaVuSans.ttf`
- `fonts/DejaVuSans-Bold.ttf`

Их нужно загрузить на GitHub вместе с `app.py`, иначе Pillow может перейти на маленький fallback-шрифт.
